...
NOTE:   String length must be evenly divisible by 16byte (str_len % 16 == 0)
        You should pad the end of the string with zeros if this is not the 
		case.
 ...
 * that you can remove most of the elements in the Rcon array, because 
 * they are unused.
 *
...
{
  uint8_t i;
  for (i = 0; i < AES_BLOCKLEN; ++i) // The block in AES is always 128bit 
